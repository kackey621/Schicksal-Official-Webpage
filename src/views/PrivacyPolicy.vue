  ...
  <div class="legal-page">
    <div class="container">
      <div class="glass-panel content-section">
        ...
        <ul>
          <li>社名：Schicksal</li>
          <li>連絡先：お問い合わせフォームからお問い合わせください</li>
        </ul>
        ...
        <h2>クッキーポリシー</h2>
        <h3>1. クッキーについて</h3>
        <p>クッキーとはお客様のウェブサイト閲覧情報を、そのお客様のコンピューター（PCやスマートフォン、タブレットなどインターネット接続可能な機器）に記憶させる機能のことです。 クッキーには、当社によって設定されるもの（ファーストパーティークッキー）と、当社と提携する第三者によって設定されるもの（サードパーティークッキー）があります。</p>

        <h3>2. クッキーの利用目的</h3>
        <ul>
          <li>当社では、クッキーを、お客様がウェブサイトを閲覧する際に同じ情報を繰り返し入力することがなくなるなど、お客様の利便性向上のために使用しています。</li>
          <li>当社では、クッキーを使用して収集した情報を利用して、お客様のウェブサイトの利用状況（アクセス状況、トラフィック、ルーティング等）を分析し、ウェブサイト自体のパフォーマンス改善や、当社からお客様に提供するサービスの向上、改善のために使用することがあります。</li>
          <li>また、この分析にあたっては、主に以下のツールが利用され、ツール提供者に情報提供されることがあります。
            <ul>
              <li><strong>Google アナリティクス</strong></li>
            </ul>
          </li>
          <li>この他、クッキーは、提携する広告配信サービス提供会社における行動ターゲティング広告の配信に使用される場合があります。</li>
        </ul>

        <h3>3. クッキーの拒否方法</h3>
        <h4>全てのクッキーを拒否する方法</h4>
        <p>お客様がブラウザの設定を変更することによりクッキーを無効にすることが可能です。ただし、クッキーを無効にした場合は、一部のサービスが受けられない場合があります。 クッキーの設定の変更方法については、各ブラウザの製造元へご確認ください。</p>

        <h4>特定のクッキーを拒否する方法</h4>
        <p>広告配信サービス提供会社への情報提供を停止するための方法は各社へお問い合わせください。以下に記載する提携先の主な広告配信サービス提供会社各社のURLからでもご確認いただけます。</p>

        <h3>4. サードパーティクッキーによる送信情報</h3>
        <p>本サービスでは、アクセス解析と広告配信の目的で、サードパーティークッキーを使用しています。 サードパーティークッキーによる送信情報等は以下のとおりです。</p>
        ...
        <div class="table-container">
          <table>
            ...
            <tbody>
              ...
              <tr>
                <td><strong>クッキーによってユーザーが送信する情報</strong></td>
                <td>・インターネット通信に通常用いられるシステム、デバイス、ネットワーク、通信に関する情報<br>・位置情報<br>・サイト・アプリ上での行動に関するデータ<br>・閲覧ページに関するデータ<br>・ユーザー識別子（cookie、端末識別子等）<br>詳細はGoogle のウェブサイトをご参照ください。</td>
              </tr>
              <tr>
                <td><strong>情報の送信先</strong></td>
                <td>Google LLC及びその関係会社</td>
              </tr>
              <tr>
                <td><strong>当社での利用目的</strong></td>
                <td>利用者による閲覧の傾向や履歴の分析のため。<br>詳細は Google のウェブサイトをご参照ください。</td>
              </tr>
              <tr>
                <td><strong>送信先での利用目的</strong></td>
                <td>同上</td>
              </tr>
            </tbody>
          </table>
